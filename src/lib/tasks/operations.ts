import { collection, doc, getDocs, updateDoc, Timestamp, query, orderBy } from 'firebase/firestore';
  ...
  try {
    ...
    snapshot.docs.forEach(doc => {
      ...
      area.tasks.push({
        ...
        completedAt: completedAt, // Keep the last completion date for history
